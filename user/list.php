                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="#" data-id="<?php echo $usuario->Id ?>" class="btn text-white btn-sm btn-outline-secondary btn-danger delete-button"><i class="fa fa-trash-o" aria-hidden="true"></i> Eliminar</a>
                                                </div>
                                            </th>
